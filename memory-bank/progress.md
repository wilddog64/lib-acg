...
- [ ] **CDP reconnect after blank tab** — IN PROGRESS. Branch: `fix/acg-credentials-cdp-reconnect`. Bug: `docs/bugs/2026-05-02-acg-credentials-cdp-reconnect-after-blank-tab.md`. `contexts()` stale after blank tab — disconnect+reconnect required.
