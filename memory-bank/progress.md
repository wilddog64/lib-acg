...
- [ ] **ACG extend surface timing gap** — IN PROGRESS. `playwright/acg_extend.js` now dismisses lingering confirmation modals, polls for the extend button after clicking Open Sandbox, and captures a failure screenshot if the surface never appears. Bug: `docs/bugs/2026-04-26-acg-extend-session-extended-modal-blocks-button.md`.
