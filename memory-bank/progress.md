...
- [x] **CDP empty-contexts fix** — DONE (`b5327fb`). Branch: `fix/acg-credentials-cdp-empty-contexts`. Bug: `docs/bugs/2026-05-02-acg-credentials-cdp-empty-contexts.md`. Open blank tab via `/json/new` when `contexts()` returns empty.
